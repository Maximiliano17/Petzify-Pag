   ...
   <>
    ...
    <div id="SobreNosotros" className={styles.contenedor}> 
      <section className={styles.Informacion}>
       ...
       <h2><br></br>
         Nuestro objetivo principal es ayudar y marcar la diferencia. Trabajamos incansablemente para crear conciencia sobre los desafíos que enfrentan los animales domésticos y brindarles el apoyo que necesitan. Nos preocupamos profundamente por su salud, alimentación, cuidado y la prevención del maltrato animal.
         En Petzify, no solo nos centramos en la adopción responsable, sino que también promovemos la educación y la sensibilización acerca de las necesidades específicas de cada especie. Creemos firmemente en que todos los animales merecen una vida plena y feliz, y nos esforzamos por brindarles las oportunidades necesarias para lograrlo.
         Colaboramos con refugios de animales, organizaciones benéficas y expertos en el cuidado de animales para brindar el mejor apoyo posible. Organizamos eventos, campañas de adopción y programas de esterilización, y ofrecemos recursos valiosos para aquellos que deseen aprender más sobre el cuidado adecuado de sus mascotas.
       </h2>
       <h2><br></br>
